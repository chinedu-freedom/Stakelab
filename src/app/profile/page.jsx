  ...
  return (
    <UserSidebarLayout>
      <div className="max-w-4xl mx-auto space-y-6 font-sans animate-in fade-in duration-300 pb-16">
        {/* Page Header */}
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-2 border-b border-[#182848]/60">
          <div>
          ...
          <Link
            href="/account"
            className="self-start sm:self-end px-4 py-2.5 rounded-xl bg-[#0a1835] border border-[#182848] text-slate-300 hover:text-white font-bold text-xs flex items-center gap-2 transition-all shadow-md whitespace-nowrap shrink-0 cursor-pointer"
          >
        ...
        <div className="bg-[#0a1835] border border-[#182848] rounded-3xl overflow-hidden shadow-2xl">
          <div className="bg-[#0e1d3e] border-b border-[#182848] px-4 sm:px-6 py-4">
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-sm sm:text-base font-extrabold text-white font-righteous flex items-center gap-2">
                <UserCheck className="w-4 h-4 sm:w-5 sm:h-5 text-[#fe780b]" /> Personal Profile
              </h2>

              {user?.status === 'SUSPENDED' || user?.is_suspended ? (
                <span className="px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-red-500/10 border border-red-500/20 text-red-400 text-[10px] sm:text-[11px] font-bold whitespace-nowrap shrink-0">
                  <span className="hidden sm:inline">Account </span>Suspended
                </span>
              ) : user?.status === 'PENDING' ? (
                <span className="px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[10px] sm:text-[11px] font-bold whitespace-nowrap shrink-0">
                  <span className="hidden sm:inline">Account </span>Pending
                </span>
              ) : (
                <span className="px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-[10px] sm:text-[11px] font-bold whitespace-nowrap shrink-0">
                  <span className="hidden sm:inline">Account </span>Active
                </span>
              )}
            </div>
            <p className="text-xs text-slate-400 mt-1">Note: Full Name, Username, and Email are fixed for security.</p>
          </div>
